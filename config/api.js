const ApiRootUrl = 'https://shop.htmlk.cn/api/';
...
module.exports = {
  ...
  CardcodeUrl: ApiRootUrl + 'card/code',
  addcardUrl: ApiRootUrl + 'card/addcard',
  cardlistUrl: ApiRootUrl + 'card/cardlist',
  cardpwdUrl: ApiRootUrl + 'card/cardpwd',
